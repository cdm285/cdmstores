...
import { handleChangePassword, handleFacebookAuth, handleForgotPassword, handleGoogleAuth, handleLogin, handleLogout, handleMe, handleRefresh, handleRegister, handleResetPassword, handleSendVerificationEmail, handleVerifyEmail } from './routes/auth.js';
...
import { handle2FADisable, handle2FASetup, handle2FAVerify, handle2FAVerifySetup } from './routes/twofa.js';
import { handleCreateAddress, handleDeleteAddress, handleGetAddresses, handleSetDefaultAddress, handleUpdateAddress, handleUpdateProfile, handleUserOrders } from './routes/user.js';
